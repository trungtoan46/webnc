        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300">
              ...
              Sứ mệnh của chúng tôi là mang đến trải nghiệm mua sắm tốt nhất cho khách hàng.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products" className="text-gray-300 hover:text-white">Sản phẩm</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/category/1" className="text-gray-300 hover:text-white">Danh mục 1</Link>
              </li>
              <li>
                <Link to="/category/2" className="text-gray-300 hover:text-white">Danh mục 2</Link>
              </li>
              <li>
                <Link to="/category/3" className="text-gray-300 hover:text-white">Danh mục 3</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <p className="mb-2">Thành phố HCM, Việt Nam</p>
